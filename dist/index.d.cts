import { OptionalId, Document, ObjectId, MongoClient, MongoClientOptions, WriteConcern, ServerApiVersion } from 'mongodb';
...
export { EinfachMongoDbCollection, type EinfachMongoDbDocument };
